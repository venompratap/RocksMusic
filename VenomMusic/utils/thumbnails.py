...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("VenomMusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("VenomMusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("VenomMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("VenomMusic/assets/play_icons.png")
